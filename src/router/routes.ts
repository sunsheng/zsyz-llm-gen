  ...
  },
  {
    ...
    children: [
      ...
      // ===== 模块六: 风险预警 =====
      {
        ...
        redirect: '/warning/dev/indicators',
        children: [
          {
            path: 'dev',
            name: 'WarningDev',
          ...
          {
            path: 'relocation',
            name: 'WarningRelocation',
            meta: { title: '企业外迁预警' },
            redirect: '/warning/relocation/indicators',
            children: [
              {
                path: 'indicators',
                name: 'WarningRelocationIndicators',
                component: lazy('warning/relocation-warning/IndicatorSystem'),
                meta: { title: '预警指标体系' },
              },
              {
                path: 'signals',
                name: 'WarningRelocationSignals',
                component: lazy('warning/relocation-warning/IndirectRiskSignal'),
                meta: { title: '间接风险信号' },
              },
              {
                path: 'model',
                name: 'WarningRelocationModel',
      ...
      // ===== 模块七: 区域地图 =====
      {
        ...
        redirect: '/regional-map/ranking/indicator-system',
        children: [
          {
            path: 'ranking',
            name: 'RegionalMapRanking',
            meta: { title: '园区榜单' },
            redirect: '/regional-map/ranking/indicator-system',
            children: [
              {
                path: 'indicator-system',
                name: 'RegionalMapRankingIndicatorSystem',
                component: lazy('regional-map/ranking/IndicatorSystem'),
                meta: { title: '榜单指标体系' },
              },
              {
                path: 'enterprise-comprehensive',
                name: 'RegionalMapRankingEnterpriseComprehensive',
                component: lazy('regional-map/ranking/EnterpriseRanking'),
                meta: { title: '企业综合榜' },
              },
              {
                path: 'chain-synergy',
                name: 'RegionalMapRankingChainSynergy',
                component: lazy('regional-map/ranking/ChainRanking'),
                meta: { title: '产业链协同榜' },
              },
            ],
          },
