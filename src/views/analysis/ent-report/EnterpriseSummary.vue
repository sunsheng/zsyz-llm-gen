...
const kpiCards = ref([
  { key: 'total', label: '入驻企业', value: 1286, unit: '家', trend: 'up' as const, trendValue: '+15.4%', icon: 'UserFilled', iconColor: '#1889E8', iconBgColor: '#ECF5FF' },
  { key: 'new', label: '新增企业', value: 198, unit: '家', trend: 'up' as const, trendValue: '+28.6%', icon: 'Plus', iconColor: '#36CBCB', iconBgColor: '#E6F7F7' },
  { key: 'revenue', label: '企业总产值', value: 358.7, unit: '亿', trend: 'up' as const, trendValue: '+9.8%', icon: 'TrendCharts', iconColor: '#4ECB73', iconBgColor: '#EDFAF0' },
  { key: 'avg', label: '人均产值', value: 28.6, unit: '万', trend: 'up' as const, trendValue: '+5.3%', icon: 'Coin', iconColor: '#975FE5', iconBgColor: '#F3ECFF' }
])
...
onMounted(() => {
  ...
  barOption.value = {
    ...
    series: [{
      name: '企业数', type: 'bar', data: [86, 356, 612, 232], barWidth: '40%',
