...
const kpiCards = ref([
  { key: 'name', label: '企业名称', value: '高端装备制造产业园', unit: '', trend: 'flat' as const, trendValue: '', icon: 'OfficeBuilding', iconColor: '#1889E8', iconBgColor: '#ECF5FF' },
  { key: 'employees', label: '员工数', value: 2560, unit: '人', trend: 'up' as const, trendValue: '+8.5%', icon: 'UserFilled', iconColor: '#36CBCB', iconBgColor: '#E6F7F7' },
  { key: 'revenue', label: '年产值', value: 98.5, unit: '亿', trend: 'up' as const, trendValue: '+8.3%', icon: 'TrendCharts', iconColor: '#4ECB73', iconBgColor: '#EDFAF0' },
  { key: 'profit', label: '利润率', value: 15.8, unit: '%', trend: 'up' as const, trendValue: '+2.1%', icon: 'Coin', iconColor: '#975FE5', iconBgColor: '#F3ECFF' }
])
