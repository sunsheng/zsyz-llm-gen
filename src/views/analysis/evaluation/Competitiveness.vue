...
const kpiCards = ref([
  { key: 'comp', label: '综合竞争力', value: 82.6, unit: '分', trend: 'up' as const, trendValue: '+4.2%', icon: 'TrendCharts', iconColor: '#1889E8', iconBgColor: '#ECF5FF' },
  { key: 'res', label: '资源竞争力', value: 78.3, unit: '分', trend: 'up' as const, trendValue: '+3.5%', icon: 'DataLine', iconColor: '#36CBCB', iconBgColor: '#E6F7F7' },
  { key: 'innov', label: '创新竞争力', value: 85.1, unit: '分', trend: 'up' as const, trendValue: '+6.8%', icon: 'Opportunity', iconColor: '#4ECB73', iconBgColor: '#EDFAF0' },
  { key: 'eff', label: '效率竞争力', value: 73.9, unit: '分', trend: 'down' as const, trendValue: '-1.2%', icon: 'Odometer', iconColor: '#F2637B', iconBgColor: '#FEF0F0' }
])
