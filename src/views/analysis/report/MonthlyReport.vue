<template>
  <div class="page-container">
    <PageHeader title="月度报告" subtitle="产业运行月度分析报告">
      <template #actions>
    ...
    <div class="chart-grid">
      <div class="chart-panel">
        <h4 class="chart-panel__title">本月运营趋势</h4>
    ...
    <div class="table-section">
      <h4 class="chart-panel__title">月度数据汇总</h4>
...
onMounted(() => {
  ...
  tableData.value = getMockTableData('monthly')
