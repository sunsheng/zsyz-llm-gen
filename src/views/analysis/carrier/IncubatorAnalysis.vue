...
const kpiCards = ref([
  { key: 'incubator', label: '孵化器数量', value: 18, unit: '个', trend: 'up' as const, trendValue: '+12.5%', icon: 'Home', iconColor: '#1889E8', iconBgColor: '#ECF5FF' },
  { key: 'incubating', label: '在孵企业', value: 356, unit: '家', trend: 'up' as const, trendValue: '+28.6%', icon: 'UserFilled', iconColor: '#36CBCB', iconBgColor: '#E6F7F7' },
  { key: 'success', label: '毕业企业', value: 128, unit: '家', trend: 'up' as const, trendValue: '+18.3%', icon: 'Trophy', iconColor: '#4ECB73', iconBgColor: '#EDFAF0' },
  { key: 'rate', label: '孵化成功率', value: 72.5, unit: '%', trend: 'up' as const, trendValue: '+5.2%', icon: 'SuccessFilled', iconColor: '#FBD437', iconBgColor: '#FFF8E6' }
])
