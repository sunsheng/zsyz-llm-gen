    ...
    <div class="content-card">
      ...
      <el-table :data="results" stripe border style="width: 100%">
        ...
        <el-table-column prop="status" label="状态" width="100">
          <template #default="{ row }">
            <el-tag :type="(row.status === '洽谈中' ? 'warning' : row.status === '已接触' ? 'info' : 'info') as any" size="small">
              {{ row.status }}
            </el-tag>
          </template>
        </el-table-column>
...
onMounted(() => {
  kpiCards.value = [
    { key: 'total', label: '招商目标', value: 48, unit: '家', trend: 'up', trendValue: '+15.2%', icon: 'Aim', iconColor: '#1889E8', iconBgColor: '#ECF5FF' },
    { key: 'contacted', label: '已接触', value: 23, unit: '家', trend: 'up', trendValue: '+8.6%', icon: 'Phone', iconColor: '#36CBCB', iconBgColor: '#E6F7F7' },
    { key: 'negotiating', label: '洽谈中', value: 12, unit: '家', trend: 'up', trendValue: '+20.0%', icon: 'ChatDotRound', iconColor: '#4ECB73', iconBgColor: '#EDFAF0' },
    { key: 'signed', label: '已签约', value: 5, unit: '个', trend: 'up', trendValue: '+25.0%', icon: 'DocumentChecked', iconColor: '#FBD437', iconBgColor: '#FFF8E6' }
  ]
