...
onMounted(() => {
  ...
  growthTrendOption.value = {
    ...
    series: [
      { name: '营收增速', type: 'line', smooth: true, data: [8.2, 9.1, 7.8, 10.5, 11.2, 9.8, 12.3, 10.6, 11.8, 13.2, 12.5, 14.1] },
      { name: '利润增速', type: 'line', smooth: true, data: [6.5, 7.8, 5.9, 8.3, 9.1, 7.6, 10.2, 8.8, 9.5, 11.3, 10.1, 12.6] }
    ]
  }
