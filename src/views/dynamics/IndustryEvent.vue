...
const filterFields = [
  { key: 'status', label: '活动状态', type: 'select' as const, options: [
    { label: '即将开始', value: 'upcoming' },
    { label: '进行中', value: 'ongoing' },
    { label: '已结束', value: 'ended' }
  ]},
  { key: 'type', label: '活动类型', type: 'select' as const, options: [
...
onMounted(() => {
  const events = [
    { name: '长三角高端装备制造产业峰会', date: '2025-06-15', location: '杭州国际博览中心', scale: 800, industry: '高端装备制造', type: '峰会', status: 'upcoming', desc: '聚焦高端装备制造前沿技术，探讨产业升级路径' },
    { name: '新材料创新应用展览会', date: '2025-05-20', location: '宁波国际会展中心', scale: 1200, industry: '新材料', type: '展会', status: 'ongoing', desc: '展示新材料领域最新研究成果和产业应用' },
    { name: '生物医药产业发展论坛', date: '2025-05-10', location: '杭州洲际酒店', scale: 500, industry: '生物医药', type: '论坛', status: 'ended', desc: '深入探讨生物医药产业创新发展趋势' },
    { name: '半导体产业技术大会', date: '2025-06-22', location: '上海浦东会展中心', scale: 1000, industry: '电子信息', type: '峰会', status: 'upcoming', desc: '聚焦半导体核心技术突破与产业生态建设' },
    { name: '新能源产业投资洽谈会', date: '2025-06-08', location: '嘉兴科技城', scale: 400, industry: '新能源', type: '论坛', status: 'upcoming', desc: '新能源项目招商与投资对接' },
    { name: '数字经济创新应用大赛', date: '2025-05-18', location: '杭州云栖小镇', scale: 600, industry: '数字创意', type: '展会', status: 'ongoing', desc: '推动数字技术与实体经济深度融合' },
    { name: '节能环保技术交流会', date: '2025-04-28', location: '绍兴国际酒店', scale: 300, industry: '节能环保', type: '论坛', status: 'ended', desc: '交流环保新技术新工艺，促进绿色发展' },
    { name: '智能制造装备博览会', date: '2025-07-05', location: '温州国际会展中心', scale: 900, industry: '高端装备制造', type: '展会', status: 'upcoming', desc: '展示智能制造装备最新产品与解决方案' }
  ]
