...
const filterFields = [
  ...
  { key: 'level', label: '类型', type: 'select' as const, options: [
...
onMounted(() => {
  const insights = [
    { title: '2025年高端装备制造产业发展趋势深度分析', category: '高端装备制造', level: 'deep', author: '产业研究院', summary: '从全球竞争格局、技术创新方向、市场需求变化三个维度，深入分析高端装备制造产业未来发展趋势及投资机遇。' },
    { title: '新材料产业链安全评估专题报告', category: '新材料', level: 'topic', author: '战略研究中心', summary: '聚焦关键原材料供应安全，评估产业链薄弱环节，提出保障策略建议。' },
    { title: '生物医药创新药出海路径洞察', category: '生物医药', level: 'deep', author: '医药产业组', summary: '分析中国创新药出海的成功案例与挑战，梳理合规路径与市场选择策略。' },
    { title: '半导体国产替代进展与机遇专题', category: '电子信息', level: 'topic', author: '技术分析部', summary: '追踪半导体国产替代最新进展，评估各环节突破情况及市场机遇。' },
    { title: '新能源技术路线演进深度分析', category: '新能源', level: 'deep', author: '能源研究院', summary: '从储能、氢能、光伏等维度分析新能源技术路线演进方向及产业化前景。' },
    { title: '数字经济赋能制造业转型路径研究', category: '数字创意', level: 'topic', author: '数字化转型中心', summary: '研究数字技术在制造业全流程的应用路径，分析转型成效与典型模式。' },
    { title: '节能环保产业"双碳"目标下的新机遇', category: '节能环保', level: 'deep', author: '绿色发展部', summary: '分析"双碳"目标对节能环保产业的驱动效应，识别高增长细分领域。' },
    { title: '长三角产业协同发展专题研究', category: '现代服务业', level: 'topic', author: '区域经济组', summary: '研究长三角产业协同现状与问题，提出深化协作的政策建议。' }
  ]
