...
export function getMockKpiCards(): KpiCard[] {
  return [
    { key: 'park', label: '园区数量', value: 12, unit: '个', trend: 'up', trendValue: '+8.3%', icon: 'OfficeBuilding', iconColor: '#1889E8', iconBgColor: '#ECF5FF' },
    { key: 'building', label: '楼栋数量', value: 156, unit: '栋', trend: 'up', trendValue: '+5.2%', icon: 'School', iconColor: '#36CBCB', iconBgColor: '#E6F7F7' },
    { key: 'resource', label: '房源数量', value: 2340, unit: '套', trend: 'up', trendValue: '+12.1%', icon: 'House', iconColor: '#4ECB73', iconBgColor: '#EDFAF0' },
    { key: 'area', label: '建筑面积', value: 89.6, unit: '万m²', trend: 'up', trendValue: '+6.7%', icon: 'DataLine', iconColor: '#FBD437', iconBgColor: '#FFF8E6' },
    { key: 'enterprise', label: '入驻企业', value: 1286, unit: '家', trend: 'up', trendValue: '+15.4%', icon: 'UserFilled', iconColor: '#975FE5', iconBgColor: '#F3ECFF' },
    { key: 'revenue', label: '年产值', value: 358.7, unit: '亿元', trend: 'up', trendValue: '+9.8%', icon: 'TrendCharts', iconColor: '#F2637B', iconBgColor: '#FEF0F0' }
  ]
}
  ...
  switch (type) {
    ...
    case 'contribution-bar':
      return {
        ...
        data: {
          ...
          series: [
            { name: '产值(亿)', data: [98.5, 76.3, 62.1, 55.8, 35.4, 30.6] }
          ]
        }
      }
    case 'growth-line':
    ...
    case 'scatter-distribution':
      return {
        type: 'scatter',
        title: '企业分布散点图',
        data: Array.from({ length: 50 }, () => [Math.random() * 100, Math.random() * 100, Math.random() * 50 + 10])
      }
    default:
      return {
        type: 'line',
