// 精准招商 API
import { getMockTargets, getMockRecommendResults, getMockInvestProjects, getMockRelationGraph, getMockAnchorEnterprises, getMockLeadingEnterprises, getMockRankings, getMockQualifiedEnterprises, getMockFunds, getMockResearchInstitutions } from '@/api/mock/invest'
...
export function fetchEnterpriseList(params: { current?: number; pageSize?: number; keyword?: string; industry?: string; city?: string }): Promise<PaginatedData<EnterpriseListItem>> {
